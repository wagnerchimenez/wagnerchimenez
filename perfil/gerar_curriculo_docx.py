#!/usr/bin/env python3
"""Gera Curriculo_Wagner_Lima_Chimenez.docx a partir do conteúdo melhorado."""
...
def main():
    ...
    add_product(
        ...
        [
            ...
            "Stack: PHP, Laravel, Inertia.js — segundo produto SaaS (entrega ponta a ponta)",
        ],
    )
    add_product(
        doc,
    ...
    skills = [
        ...
        ("Complementar: ", "NestJS, Flutter, React Native"),
    ]
